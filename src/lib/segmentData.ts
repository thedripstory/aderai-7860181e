...
export const SEGMENTS: Segment[] = [
  ...
  // CUSTOMER LIFECYCLE & VALUE (15 segments)
  {
    ...
    description: "Never purchased, recently joined email list",
    category: "Customer Lifecycle & Value",
    icon: "🌱",
    definition: "0 orders all-time, in list < 30 days",
  },
  {
    id: "recent-first-time",
    name: "Recent First-Time Customers",
    description: "Exactly 1 purchase, made in last 30 days",
    category: "Customer Lifecycle & Value",
    icon: "🎉",
    definition: "Exactly 1 order all-time AND 1+ orders in last 30 days",
  },
  {
    id: "repeat-customers",
    name: "Repeat Customers",
    description: "2 or more purchases all time",
    category: "Customer Lifecycle & Value",
    icon: "🔄",
    definition: "Order count ≥ 2 all-time",
  },
  {
    id: "one-time-buyers",
    ...
    category: "Customer Lifecycle & Value",
    icon: "1️⃣",
    definition: "Order count = 1 all-time",
  },
  {
    id: "active-customers",
    ...
    category: "Customer Lifecycle & Value",
    icon: "⚡",
    definition: "1+ orders in last 90 days",
  },
  {
    id: "lapsed-customers",
    name: "Lapsed Customers",
    description: "Has purchased, but not in last 180 days",
    category: "Customer Lifecycle & Value",
    icon: "😴",
    definition: "1+ orders all-time AND 0 orders in last 180 days",
  },
  {
    id: "churned-customers",
    name: "Churned Customers",
    description: "Has purchased, but not in last 365 days",
    category: "Customer Lifecycle & Value",
    icon: "💔",
    definition: "1+ orders all-time AND 0 orders in last 365 days",
  },
  {
    id: "vip-customers",
    name: "VIP Customers",
    description: "Placed 5 or more orders all time",
    category: "Customer Lifecycle & Value",
    icon: "👑",
    definition: "Order count ≥ 5 all-time",
  },
  {
    id: "big-spenders",
    name: "Big Spenders",
    ...
    category: "Customer Lifecycle & Value",
    icon: "💰",
    definition: "Historic CLV > {currencySymbol}{vipThreshold}",
  },
  {
    id: "bargain-shoppers",
    ...
    category: "Customer Lifecycle & Value",
    icon: "🏷️",
    definition: "Historic CLV < {currencySymbol}{aov}",
  },
  {
    id: "high-churn-risk",
    name: "High Churn Risk",
    description: "Klaviyo predicts high churn probability",
    category: "Customer Lifecycle & Value",
    icon: "⚠️",
    definition: "Predictive: Churn Risk = High",
    unavailable: true,
  ...
  },
  {
    ...
    description: "Predicted next order within 14 days",
    category: "Customer Lifecycle & Value",
    icon: "🎯",
    definition: "Predictive: Next Order < 14 days",
    unavailable: true,
    unavailableReason: "Requires Klaviyo Predictive Analytics",
  },
  {
    id: "predicted-vips",
    name: "Predicted VIPs",
    description: "Predicted high CLV in next 365 days",
    category: "Customer Lifecycle & Value",
    icon: "⭐",
    definition: "Predictive: Future CLV > {currencySymbol}{vipThreshold}",
    unavailable: true,
    unavailableReason: "Requires Klaviyo Predictive Analytics",
  },
  {
    ...
    description: "Average Order Value above {currencySymbol}{highValueThreshold}",
    category: "Customer Lifecycle & Value",
    icon: "📈",
  ...
  {
    id: "low-aov",
    name: "Low AOV Customers",
    description: "Average Order Value below {currencySymbol}{aov}",
    category: "Customer Lifecycle & Value",
    icon: "📉",
