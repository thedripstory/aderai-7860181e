...
export default function BrandLogin() {
  ...
  const handleSetNewPassword = async () => {
    ...
    try {
      ...
      setNewPassword("");
      setConfirmPassword("");
      window.history.replaceState({}, document.title, "/brand-login");
    } catch (error: any) {
      toast({
        title: "Error",
  ...
  const handlePasswordReset = async () => {
    ...
    try {
      const { error } = await supabase.auth.resetPasswordForEmail(resetEmail, {
        redirectTo: `${window.location.origin}/brand-login`,
      });
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  disabled={resetLoading}
                  className="flex-1 bg-primary text-primary-foreground px-4 py-3 rounded-lg font-semibold hover:bg-primary/90 transition-all disabled:opacity-50 shadow-lg"
                >
          ...
          {isSettingNewPassword ? (
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                disabled={loading}
                className="w-full bg-primary text-primary-foreground font-semibold py-3 rounded-lg hover:bg-primary/90 transition-all disabled:opacity-50 shadow-lg"
              >
