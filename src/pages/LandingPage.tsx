        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              <div className="absolute right-5 top-1/2 -translate-y-1/2 w-12 h-12 bg-background rounded-full scale-100 group-hover:scale-[15] transition-transform duration-700" />
