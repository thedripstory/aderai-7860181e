...
serve(async (req) => {
  ...
  try {
    ...
    logStep("New price requested", { newPriceId });
    ...
    logStep("Current subscription found", { subscriptionId: subscription.id, itemId: currentSubscriptionItemId });
    ...
    logStep("ERROR in change-plan", { message: errorMessage });
