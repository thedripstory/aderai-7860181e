...
import { Body, Container, Head, Heading, Html, Img, Preview, Section, Text, Button, Hr } from 'npm:@react-email/components@0.0.22'
...
const header = { padding: '32px 32px 16px', textAlign: 'center' as const, borderBottom: `3px solid ${BRAND}` }
        ...
        <Container style={container}>
          ...
          <Section style={footer}>
            <Text style={{ margin: 0, color: '#94a3b8', fontSize: '12px' }}>
              Aderai, powered by Klaviyo.
            </Text>
            <Text style={{ margin: '6px 0 0', color: '#94a3b8', fontSize: '12px' }}>
              Need help? Email hello@aderai.io
            </Text>
          </Section>
        </Container>
      </Body>
...
export const styles = { main, container, header, content, h1, text, button, buttonWrap, footer, link }
